# see overpass-queries.txt for reference. this was exported from http://overpass-turbo.eu/
...
# way["highway"="footway"]["layer"="-1"](53.53275790467149,-113.51245880126953,53.54683559190011,-113.48499298095703);(._;>;);out;;
pedway-underground.json:
